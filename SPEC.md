# Malawi Financial Intelligence — Specification
...
> The budget pipeline is the only one that requires Qdrant. Weekly
...
> **Time-critical**: `TobaccoAuctionExtractor` and `TIMBScraper` must
...
- [ ] **v0.8** — Live data pipeline: TobaccoAuctionExtractor + TIMBScraper (before April 2026)
